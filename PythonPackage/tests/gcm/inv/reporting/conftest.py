...
def skye_fund_inputs():
    f = open(
        ...
        + "\\test_data\\Skye_fund_inputs_2022-03-31.json"
    )
    return json.load(f)
...
def skye_primary_peer_inputs():
    f = open(
        os.path.dirname(__file__)
        + "\\test_data\\GCM TMT_peer_inputs_2022-03-31.json"
    )
    return json.load(f)
...
def skye_secondary_peer_inputs():
    f = open(
        os.path.dirname(__file__)
        + "\\test_data\\GCM Equities_peer_inputs_2022-03-31.json"
    )
    return json.load(f)
...
def skye_eh_inputs():
    f = open(
        os.path.dirname(__file__)
        + "\\test_data\\EHI100 LongShort Equity_eurekahedge_inputs_2022-03-31.json"
    )
    return json.load(f)
