...
class PerformanceQualityReportData(ReportingRunnerBase):
    ...
    def get_performance_quality_report_inputs(self):
        ...
        fund_dimn = inv_group.get_dimensions(
        ...
        eurekahedge_returns = benchmarks.get_eurekahedge_returns(start_date=self._start_date, end_date=self._end_date, benchmarks_names=eh_benchmark_names)
        ...
        gcm_peer_returns = benchmarks.get_altsoft_peer_returns(start_date=self._start_date, end_date=self._end_date, peer_names=peer_groups)
        ...
        market_factor_returns = factors.get_returns(
        ...
        rba_risk_1y = inv_group.get_average_risk_decomp_by_group(
            start_date=start_1y,
            end_date=self._end_date,
        ...
        rba_risk_3y = inv_group.get_average_risk_decomp_by_group(
            start_date=start_3y,
            end_date=self._end_date,
            group_type="FactorGroup1",
            frequency="M",
        ...
        rba_risk_5y = inv_group.get_average_risk_decomp_by_group(
            start_date=start_5y,
            end_date=self._end_date,
            group_type="FactorGroup1",
            frequency="M",
        ...
        rba_r2_1y = inv_group.get_average_adj_r2(
            start_date=start_1y,
            end_date=self._end_date,
            frequency="M",
            window=36,
        ...
        rba_r2_3y = inv_group.get_average_adj_r2(
            start_date=start_3y,
            end_date=self._end_date,
            frequency="M",
            window=36,
        ...
        rba_r2_5y = inv_group.get_average_adj_r2(
            start_date=start_5y,
            end_date=self._end_date,
            frequency="M",
            window=36,
        ...
        pba_publics = inv_group.get_pba_ts_by_group(
            start_date=self._start_date,
            end_date=self._end_date,
        ...
        pba_privates = inv_group.get_pba_ts_by_group(
            start_date=self._start_date,
            end_date=self._end_date,
            group_type="FactorGroup",
            frequency="M",
