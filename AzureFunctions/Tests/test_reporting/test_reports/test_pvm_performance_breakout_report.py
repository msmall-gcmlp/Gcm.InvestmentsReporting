...
class TestPerformanceBreakDown(object):
    ...
    def test_new_report_run(self):
        ...
        with Scenario(
            ...
            report_display_name = 'PE Portfolio Performance x Vintage & Realization Status'
            ...
            for port_name in port_list:
                ...
                recursion_iterate_controller = [
                    [
                        ...
                        # ["Portfolio", "PredominantInvestmentType", "BurgissSector"],
                        # ["Portfolio", "PredominantInvestmentType", "BurgissSector", "DealName"]
                        # ["Portfolio"],
                        ...
                        ["Portfolio"],
                        ["Portfolio", "PredominantInvestmentType"],
                        ["Portfolio", "PredominantInvestmentType", "PredominantSector"],
                        ["Portfolio", "PredominantInvestmentType", "PredominantSector", "DealName"]
                    ],
                    [
                        ["Portfolio"],
